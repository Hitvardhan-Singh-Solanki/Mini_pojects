...
def draw(c):
    ...
    c.draw_text(str(score1), (185, 40), 40, "Green")
    ...
    c.draw_circle((WIDTH/2,HEIGHT/2), 100, 1, 'White')
    c.draw_text('Game by Hitvardhan', (WIDTH/2-55,HEIGHT/2), 12, 'Red')
    # draw paddles
...
frame.add_button("End Game", end_handler,200)
# start frame
frame.start()
new_game()
